    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="" target="_blank">
                ...
                <span class="ms-3 font-weight-bold">Organize By KUNTUM</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/tables.html">
                        ...
                        <span class="nav-link-text ms-1">All Package</span>
                    </a>
                </li>
                <!--  Menu  -->
                <li class="nav-item">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Custom Page</h6>
                </li>
                <!--  Menu  -->
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/sign-in.html">
                        ...
                        <span class="nav-link-text ms-1">Attire</span>
                    </a>
                </li>
        ...
        <div class="d-flex align-items-center justify-content-center">
            <a class="btn bg-gradient-primary  w-80 " href="/" type="button">Log Out</a>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <p class="text-lg mb text-capitalize font-weight-bold m-sm-2">Today's Views</p>
                                </div>
                                <div class="col-4 text-end ">
                                    <div class=" icon-shape bg-primary text-center">
                                        <i class="text-lg opacity-10">01</i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-7 text-end ">
                                    <p class="text-lg mb text-capitalize font-weight-bold m-sm-2">New User</p>
                                </div>
                                <div class="col-4 text-end">
                                    <div class=" icon-shape bg-primary  text-center ">
                                        <i class="text-lg opacity-10">01</i>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-7 text-end">
                                <p class="text-lg mb text-capitalize font-weight-bold m-sm-2">New Order</p>
                                </div>
                                <div class="col-4 text-end">
                                    <div class=" icon-shape bg-primary  text-center border-radius-md">
                                        <i class="text-lg opacity-10">01</i>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-7 text-end">
                                <p class="text-lg mb text-capitalize font-weight-bold m-sm-2">All Order</p>
                                </div>
                                <div class="col-4 text-end">
                                    <div class=" icon-shape bg-primary  text-center border-radius-md">
                                        <i class="text-lg opacity-10">01</i>
                ...
                <div class="col-lg-5">
                    <div class="card h-100 p-3">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
                            ...
                            <h3 class="text-center m-sm-5">View Months</h3>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
                                    <span class="mask bg-gradient-dark"></span>
                                    <h3 class="text-center m-sm-5">View Years</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Submit Time</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Drtail</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">John Ohsen</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-xs font-weight-bold"> 01:0 0 </span>
                                            </td>
                                            <td class="align-middle">
                                                <div class="progress-wrapper w-75 mx-auto">
                                                    <div class="progress-bar bg-gradient-info w-60"> </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
